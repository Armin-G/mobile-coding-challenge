...
class JSONService{
    ...
    func sendRequest(){
        let accessKey = "c091e96466487072b7924117c85475761f6d14b5c8373fa1becbfc0904455385"
        let jsonURLString = "https://api.unsplash.com/photos/curated/?client_id=\(accessKey)"
